...
geom_point()+ # create scatterplot
  labs(x="the number of milk cows (in millions)",y="milk production (in millions of pounds)") + # add x,y label
  ggtitle("Average milk production per cow")+ # add title
theme(plot.title = element_text(hjust = 0.5))  # center the title
```

Overall, milk production per cow appears to decrease as the number of milk cows increases. This negative relationship indicates that larger herds may produce less milk per cow.
...
At the beginning, whole milk has the largest production, Eggnog has the lowest production. Now, reduced fat milk and whole milk have the largest production, while Eggnog production remain the lowest. Production of flavored milk(not whole) is increasing these years, and production of buttermilk is descending.
